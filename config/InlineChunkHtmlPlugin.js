...
class InlineChunkHtmlPlugin {
    ...
    getInlinedLink(publicPath, assets, tag) {
        if (!(tag.attributes && tag.attributes.rel === 'stylesheet' && tag.attributes.href)) {
            return tag;
        }
    ...
    getInlinedTag(publicPath, assets, tag) {
        if (tag.tagName === 'script') {
            return this.getInlinedScript(publicPath, assets, tag);
        }
        if (tag.tagName === 'link') {
            return this.getInlinedLink(publicPath, assets, tag);
        }
        return tag;
    }
